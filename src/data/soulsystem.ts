...
export const BODIES: Body[] = [
  ...
  },
  {
    ...
    version: 'v0.1.0',
    repo: 'https://github.com/impire-io/soulidentity',
    oneLiner:
  ...
  },
  {
    ...
    zoom: 2.2,
    hue: 'soulrealm',
    status: 'three backends',
    version: 'v0.1.0',
    repo: 'https://github.com/impire-io/soulrealm',
    oneLiner:
  ...
  },
  {
    ...
    version: 'v0.3.4',
    repo: 'https://github.com/impire-io/soulfold',
    oneLiner:
  ...
  },
  {
    ...
    focus: { x: 590, y: 375 },
    hue: 'soulnode',
    status: 'released binaries',
    version: 'v0.3.1',
    repo: 'https://github.com/impire-io/soulnode',
    oneLiner:
      'The single-binary distribution: the whole stack on a machine you own — soulnode init && soulnode up, point a client at the printed URL.',
  },
];
